...
const Hero: FC = () => {
  return (
    <section className="relative w-full mx-auto min-h-[calc(100vh-100px)] h-full flex flex justify-center items-center md:items-end">
      <div
      ...
      <div className="max-w-7xl w-full flex flex-col justify-center items-center gap-5  px-4 md:px-10 pt-24 pb-[150px] md:items-end ">
        ...
        <p className="max-w-2xl text-[var(--color-white)] text-lg text-center font-semibold md:text-end">
          ...
          games has influenced my development style, and I strive to make every
          project as engaging and immersive as possible. With a focus on both
          front-end and back-end development, I am able to bring my ideas to
          life and create applications that truly stand out from the crowd.
        </p>
