              ...
              <div className='flex flex-col gap-5'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                  <div className='border-2 border-[var(--color-grey)] rounded-md'>
                    ...
                    <div className='flex flex-col mt-2 border-t-2 border-[var(--color-grey)] flex-wrap justify-content-center align-items-center overflow-hidden overflow-y-auto'>
                  ...
                  <div className='border-2 border-[var(--color-grey)] rounded-md '>
                    ...
                    <div className='flex flex-col mt-2  border-t-2 border-[var(--color-grey)]  justify-content-center align-items-center overflow-hidden overflow-y-auto h-[200px]'>
