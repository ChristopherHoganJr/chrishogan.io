...
const DesktopLink: FC<NavLink> = ({ url, title }) => {
  return (
    <Link
      href={url}
      className='relative h-full desktop-navlink flex items-center px-10  transition-all bg-[var(--color-black)] text-[var(--color-white)] hover:text-[var(--color-black)] group font-bold'>
      {title}
